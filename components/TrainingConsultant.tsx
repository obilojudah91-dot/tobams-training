export default function TrainingConsultant() {
  return (
    <section id="consultant">
      <p className="label label-pink" style={{ marginBottom: '4px' }}>
      ...
      <div className="feature-grid-4">
        <div className="fg-item">
          ...
          <p>
            Gain insight from seasoned professionals in the field as they mentor you through the
            subtleties of business analysis.
          </p>
        </div>
        <div className="fg-item">
          <h4>Interactive Workshops</h4>
          <p>
            Engage in hands-on workshops designed to enhance your training capabilities and provide
            practical insights.
          </p>
        </div>
        <div className="fg-item">
          ...
          <p>
            Access a robust curriculum that covers fundamental principles and advanced methodologies,
        ...
        <div className="fg-item">
          ...
          <p>
            You will attain a globally recognized certification, opening doors to new career
